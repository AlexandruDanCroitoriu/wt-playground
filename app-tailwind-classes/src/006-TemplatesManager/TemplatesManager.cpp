...
// TemplatesManager::TemplatesManager(std::string default_folder_path)
...
//     folders_ = getFolders();
//     editor_ = addWidget(std::make_unique<MonacoEdditor>("xml"));
...
// void TemplatesManager::setTreeFolderWidgets()
// {
//     folders_tree_wrapper_->clear();
...
// std::vector<std::pair<std::string, std::vector<std::string>>> TemplatesManager::getFolders()
// {
...
// Wt::WMessageBox* TemplatesManager::createMessageBox(std::string title, std::string temp)
// {
